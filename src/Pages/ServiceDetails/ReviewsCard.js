...
const ReviewsCard = ({review}) => {
    const {serviceName, ratings, customer, email, userImage, message} = review
    return (
        <div>
             <div className="container flex flex-col w-full  p-6 mx-auto divide-y rounded-none divide-gray-700 bg-gray-200 dark:text-gray-900">
