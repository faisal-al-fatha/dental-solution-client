  ...
  <div className="container py-16 mx-auto flex flex-wrap">
    <div className="flex flex-wrap -mx-4 mt-auto mb-auto lg:w-1/2 sm:w-2/3 content-start sm:pr-10">
      <div className="w-full sm:p-4 px-4 mb-6">
        <h1 className="title-font font-medium text-3xl mb-2 text-gray-900">Dental Solution in Numbers</h1>
        <div className="leading-relaxed text-xl">Some Statistics</div>
      </div>
